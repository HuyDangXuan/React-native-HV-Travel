...
function createColorSet(name: ThemeName) {
  if (name === "dark") {
    return {
...
function createSemanticSet(name: ThemeName) {
  if (name === "dark") {
    return {
...
export function resolveThemeName(mode: ThemeMode, systemScheme?: "light" | "dark" | null) {
  if (mode === "system") {
