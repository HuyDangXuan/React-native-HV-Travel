...
const api = {
    ...
    get_tour_detail: (id) => `${base_url}/tours/${id}`,
    get_bookings: base_url + "/bookings",
    get_booking_detail: (id) => `${base_url}/bookings/${id}`,
    cancel_booking: (id) => `${base_url}/bookings/${id}`,
    ...
    delete_favourite_by_tour: (tourId) => `${base_url}/favourites/tour/${tourId}`,
    add_favourite_by_tour: (tourId) => `${base_url}/favourites/tour/${tourId}`,
