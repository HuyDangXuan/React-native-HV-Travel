  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>{t("paymentFlow.momo.title")}</Text>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Pressable style={styles.quickActionBtn} onPress={handleOpenMoMoApp}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.quickActionTitle}>{t("paymentFlow.momo.openAppTitle")}</Text>
            <Text style={styles.quickActionDesc}>{t("paymentFlow.momo.openAppDescription")}</Text>
          </View>
        ...
        <View style={styles.infoBox}>
          ...
          <InfoRow
            ...
            value={t("paymentFlow.momo.methodValue")}
            ui={ui}
            styles={styles}
          />
          <Divider styles={styles} />
        ...
        <View style={styles.instructionBox}>
          <Text style={styles.instructionTitle}>{t("paymentFlow.momo.instructionTitle")}</Text>

          <Text style={styles.methodTitle}>{t("paymentFlow.momo.methodOneTitle")}</Text>
          <Step n={1} text={t("paymentFlow.momo.step1")} color={ui.accent} styles={styles} />
          <Step n={2} text={t("paymentFlow.momo.step2")} color={ui.accent} styles={styles} />
          <Step n={3} text={t("paymentFlow.momo.step3")} color={ui.accent} styles={styles} />

          <Text style={styles.methodTitle}>{t("paymentFlow.momo.methodTwoTitle")}</Text>
          <Step n={1} text={t("paymentFlow.momo.step4")} color={ui.accent} styles={styles} />
          <Step n={2} text={t("paymentFlow.momo.step5")} color={ui.accent} styles={styles} />
          <Step n={3} text={t("paymentFlow.momo.step6")} color={ui.accent} styles={styles} />
          <Step n={4} text={t("paymentFlow.momo.step7")} color={ui.accent} styles={styles} />
        </View>

        <View style={styles.featuresBox}>
          <Text style={styles.featuresTitle}>{t("paymentFlow.momo.featuresTitle")}</Text>
          <Feature text={t("paymentFlow.momo.feature1")} styles={styles} ui={ui} />
          <Feature text={t("paymentFlow.momo.feature2")} styles={styles} ui={ui} />
          <Feature text={t("paymentFlow.momo.feature3")} styles={styles} ui={ui} />
        </View>

        <View style={styles.noteBox}>
          <Ionicons name="shield-checkmark" size={20} color={ui.accent} />
          <Text style={styles.noteText}>{t("paymentFlow.momo.note")}</Text>
        </View>
...
function Feature({
  ...
  return (
    <View style={styles.featureRow}>
      <Ionicons name="checkmark-circle" size={20} color={ui.accent} />
...
const createStyles = (ui: UiTokens) =>
  StyleSheet.create({
    ...
    featureText: { flex: 1, fontSize: 14, color: ui.textPrimary, lineHeight: 21 },
    noteBox: {
      flexDirection: "row",
