...
## Author Note | Ghi chú sử dụng cho portfolio

README này được viết theo hướng kỹ thuật và portfolio-ready để có thể dùng trực tiếp khi:

- đưa repo vào CV
- trình bày với nhà tuyển dụng
- làm phần mô tả dự án trên GitHub

Nếu cần, có thể bổ sung thêm:

- ảnh chụp màn hình thực tế
- GIF demo các flow chính
- link backend repo
- vai trò cá nhân trong team theo format CV
